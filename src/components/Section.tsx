      ...
      <div className='flex flex-col lg:flex-row gap-8'>
        ...
        <div className='flex flex-col items-center lg:items-start'>
          ...
          <div className='mt-4 px-4 lg:px-16'>
            <h3 className='text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800 mb-2'>Side Table</h3>
            <Button 
              variant="ghost" 
        ...
        <div className='flex-wrap'><Image
          ...
          <div className='mt-4 px-4 lg:px-16'>
            <h3 className='text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800 mb-2'>Cloud Sofa</h3>
            <Button 
              variant="ghost" 
              className='text-black text-lg sm:text-xl lg:text-2xl border-b-2 rounded-none hover:bg-black hover:text-white border-black w-[121px] h-12 mx-auto lg:mx-0'>
              View More
